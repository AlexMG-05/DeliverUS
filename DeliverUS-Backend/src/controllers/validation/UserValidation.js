...
const create = [
  ...
  check('password').exists().isString().isStrongPassword({ minLength: 3 }).withMessage('Password must be at least 8 characters long, 1 upperCase, 1 lowerCase, 1 number and 1 special character'),
