...
import { StyleSheet, View, FlatList, ImageBackground, Image, Modal, Pressable, Text, Animated } from 'react-native'
        ...
        {({ handleSubmit }) => (
          ...
          >
            ...
            <TextSemiBold textStyle={styles.totalPriceText}>
              Total Price: {(calculateTotalPrice() < 10 ? calculateTotalPrice() + restaurant.shippingCosts : calculateTotalPrice())} €
            </TextSemiBold>
